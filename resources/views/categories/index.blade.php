<x-guest-layout>
    ...
    <section class="mt-6 bg-white">
        <div class="mt-4 text-start mx-8">
            <h3 class="text-2xl font-bold text-blue-700">All Categories</h3>
        </div>
            ...
            <div class="grid lg:grid-cols-4 gap-y-6">
                ...
                <a href="{{route('categories.show', $category->id)}}">
                    <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                        <img class="w-full h-48 rounded-lg" src="{{Storage::url($category->image)}}"
                            alt="Image" />
                    <div class="px-6 py-4">
