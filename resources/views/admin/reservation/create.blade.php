                    ...
                    <form action="{{ route('admin.reservation.store') }}" method="POST">
                        ...
                        <div class="sm:col-span-12">
                            <label for="fname"
                                ...
                                Name</label>
                            <div class="mt-1 mb-2">
                                <input type="text" id="fname" aria-describedby="helper-text-explanation"
                                    class="@error('first_name') border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div class="sm:col-span-12">
                            <label for="lname"
                                ...
                                Name</label>
                            <div class="mt-1 mb-2">
                                <input type="text" id="lname" aria-describedby="helper-text-explanation"
                                    class="@error('last_name') border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div class="sm:col-span-12">
                            ...
                            <div class="mt-1 mb-2">
                                <input type="tel" id="phone" aria-describedby="helper-text-explanation"
                                    class="@error('tel_number') border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div class="sm:col-span-12">
                            <label for="res_date"
                                ...
                                Date</label>
                            <div class="mt-1 mb-2">
                                <input type="datetime-local" id="res_date" aria-describedby="helper-text-explanation"
                                    class="@error('res_date') border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    name="res_date">
                            </div>
                            @error('res_date')
                                <div class="text-red-500 text-small">{{ $message }}</div>
                        ...
                        <div class="sm:col-span-12">
                            <label for="guest_number"
                                ...
                                Number</label>
                            <div class="mt-1 mb-2">
                                <input type="number" id="guest_number" aria-describedby="helper-text-explanation"
