<x-guest-layout>
    <div
      ...
      <div class="mx-auto mt-2 text-green-600 md:text-center font-bold lg:text-lg">
          ...
          @if (Route::has("login"))
              ...
              @else
                <a href="{{route("login")}}" type="button"
                  class="inline-flex items-center justify-center px-6 py-2 text-base font-bold leading-6 text-white bg-green-600 rounded-full lg:w-full md:w-auto hover:bg-green-500 focus:outline-none">
                  Please login to make reservation
                </a>   
              @endauth
          @endif
      </div>
    ...
    {{-- Menu Section --}}
    <section class="mt-8 bg-white" id="our-menu">
        ...
        <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
          <div class="flex justify-center -mt-16 md:justify-end">
            <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
              src="{{asset ("assets/zamani.jpg")}}">
          </div>
          <div>
            <h2 class="text-3xl font-semibold text-gray-800">Kstu Restaurant</h2>
          ...
          <div class="flex justify-end mt-4">
            <a href="#" class="text-xl font-medium text-green-500">Saani Zamani</a>
          </div>
        </div>
        <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
          <div class="flex justify-center -mt-16 md:justify-end">
            <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
              src="{{asset ("assets/stanlee.jpg")}}">
          </div>
          <div>
            <h2 class="text-3xl font-semibold text-gray-800">Kstu Restaurant</h2>
            <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores deserunt
          ...
          <div class="flex justify-end mt-4">
            <a href="#" class="text-xl font-medium text-green-500">Ayaric Stanlee</a>
          </div>
        </div>
        <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
          <div class="flex justify-center -mt-16 md:justify-end">
            <img class="object-cover w-20 h-20 border-2 border-green-500 rounded-full"
              src="{{asset ("assets/bintu.jpg")}}">
          </div>
          <div>
            <h2 class="text-3xl font-semibold text-gray-800">Kstu Restaurant</h2>
            <p class="mt-2 text-gray-600">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae dolores deserunt
          ...
          <div class="flex justify-end mt-4">
            <a href="#" class="text-xl font-medium text-green-500">Hajia Bintu</a>
          </div>
        </div>
      </div>
    </section>
